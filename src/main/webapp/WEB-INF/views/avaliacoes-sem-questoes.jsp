...
<html>
<head>
    <title>Avaliações sem Questões</title>
    <style>
        ...
        .avaliacao-item { background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 15px; margin-bottom: 15px; }
...
<div class="container">
    ...
    <c:if test="${not empty avaliacoes}">
        <div class="warning-badge" style="display: inline-block; margin-bottom: 20px;">
                ${avaliacoes.size()} avaliação(ões) sem questões
        </div>
        ...
        <c:forEach items="${avaliacoes}" var="avaliacao">
            <div class="avaliacao-item">
                <div class="avaliacao-header">
                    ...
                    <div class="warning-badge">SEM QUESTÕES</div>
                </div>

                <div class="acoes">
                    <a href="/professor/avaliacoes/${avaliacao.idAvaliacao}/questoes" class="btn-small btn-add">➕ Adicionar Questões</a>
                    <a href="/professor/avaliacoes/editar/${avaliacao.idAvaliacao}" class="btn-small btn-edit">✏️ Editar Avaliação</a>
                </div>
            </div>
        </c:forEach>
    </c:if>
    ...
    <c:if test="${empty avaliacoes}">
        <div style="text-align: center; padding: 40px; color: #28a745;">
            ...
            <h3>Todas as avaliações têm questões!</h3>
            <p>Nenhuma avaliação sem questões foi encontrada.</p>
        </div>
    </c:if>
</div>
</body>
